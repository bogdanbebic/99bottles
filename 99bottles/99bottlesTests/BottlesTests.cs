...
namespace _99bottles.Tests
{
    ...
    public class BottlesTests
    {
        ...
        public void FirstVerseTest()
        {
            ...
            Assert.AreEqual(actual: new Bottles().Verse(99), expected: expected);
        }

        [TestMethod]
        public void AnotherVerseTest()
        {
            string expected =
            ...
            Assert.AreEqual(actual: new Bottles().Verse(3), expected: expected);
        }

        [TestMethod]
        public void Verse2Test()
        {
            string expected =
                "2 bottles of milk on the wall, " +
                "2 bottles of milk.\n" +
            ...
            Assert.AreEqual(actual: new Bottles().Verse(2), expected: expected);
        }

        [TestMethod]
        public void Verse1Test()
        {
            string expected =
                "1 bottle of milk on the wall, " +
                "1 bottle of milk.\n" +
            ...
            Assert.AreEqual(actual: new Bottles().Verse(1), expected: expected);
        }

        [TestMethod]
        public void Verse0Test()
        {
            string expected =
                "No more bottles of milk on the wall, " +
            ...
            Assert.AreEqual(actual: new Bottles().Verse(0), expected: expected);
        }

        [TestMethod]
        public void CoupleVersesTest()
        {
            string expected =
                "99 bottles of milk on the wall, " +
                "99 bottles of milk.\n" +
            ...
            Assert.AreEqual(actual: new Bottles().Verses(99, 98), expected: expected);
        }

        [TestMethod]
        public void FewVersesTest()
        {
            string expected =
                "2 bottles of milk on the wall, " +
                "2 bottles of milk.\n" +
            ...
            Assert.AreEqual(actual: new Bottles().Verses(2, 0), expected: expected);
        }

        [TestMethod]
        public void WholeSongTest()
        {
            string expected =
...
";
            ...
            Assert.AreEqual(actual: new Bottles().Song(), expected: expected);
        }
    }
}
